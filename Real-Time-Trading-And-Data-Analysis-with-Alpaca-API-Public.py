#https://github.com/ArisS13/Real-Time-Trading-and-Data-Analysis-with-Alpaca-API-PUBLIC-.git
...
def cancelOrders():
    ALPACA_API_KEY = input(str("Input your Alpaca API Key here: "))
    ALPACA_SECRET_KEY = input(str("Input you Alpaca Secret Key here: "))
    trading_client = api.REST(ALPACA_API_KEY, ALPACA_SECRET_KEY, "https://api.alpaca.markets")
        ...
        def status():
            ...
            if stats == "STATS":
                ...
                for position in pos:
                    ...
                    #if position.current_price < position.lastday_price:
                        #print("Price down today: ", position.lastday_price - position.current_price)
                    print("Price Change: " + position.current_price)
                time.sleep(5)
                backtomenu()
            else:
                backtomenu()
